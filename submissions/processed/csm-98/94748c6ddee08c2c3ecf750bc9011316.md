...
<!-- -->
>     --Query-> list the details of employees working at HYderabad branch.
>     --first we can find the branch  Id of Hyderabad city from branch table.
>     -- then use the branch Id to restric the rows in employee tabl.
>     select branch_id from branch where city = 'Hyderabad';
> 
> | BRANCH_ID |
> | :-------- |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=94748c6ddee08c2c3ecf750bc9011316)*
