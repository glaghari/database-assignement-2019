...
<!-- -->
>     --Now list the details of employees working at HYderabad branch.
>     select * from Employee where branch_Id = 'B001';
> 
> | EMP_ID | FIRST_NAME | LAST_NAME | EMAIL                   | POSITION   | GENDER | DOB       | HIRE_DATE | SALARY | BRANCH_ID |
> | :----- | :--------- | :-------- | :---------------------- | :--------- | :----- | :-------- | :-------- | -----: | :-------- |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=ef19050e14546ef0905890c4a8779f2c)*
