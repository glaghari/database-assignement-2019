...
>     insert into Branch values('B004','khipro','Hinglaj minder');
>     insert into Branch values('B005','ghulam nabi shah','7G road');
>     end;
>     /
> 
1 rows affected
...
>     insert into Employee
>       values('E004','chanchal','khatri','chanchalkhatri569@gmail.com','Manager','F',date '1997-03-01',date '2010-05-06',100000,'B001');
>     end;
>     /
> 
1 rows affected
...
> | B004      | khipro           | Hinglaj minder      |
> | B005      | ghulam nabi shah | 7G road             |
...
> | E004   | chanchal   | khatri    | chanchalkhatri569@gmail.com | Manager    | F      | 01-MAR-97 | 06-MAY-10 | 100000 | B001      |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=c3a39f410f19ecab374f6b23d7a5c4ef)*
