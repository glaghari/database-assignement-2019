...
<!-- -->
>     select count(*) as TotalSalary, sum(salary) as TotalSalary, avg (salary) as AverageSalary, min (salary) as MinimumSalary, max (salary) as MaximumSalary
>     from Employee
>     group by branch_id;
> 
> | TOTALSALARY | TOTALSALARY | AVERAGESALARY | MINIMUMSALARY | MAXIMUMSALARY |
> | ----------: | ----------: | ------------: | ------------: | ------------: |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=2e074891286497ce28e68f1eb3e9963c)*
