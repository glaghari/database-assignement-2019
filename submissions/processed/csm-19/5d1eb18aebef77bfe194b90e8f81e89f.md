...
>        type varchar2(10) check (type in ('House','Flat')) not null,
>        rooms varchar2(5)not null,
>        rent varchar2(5)not null,
...
>     (property_id,city,postcode,type,rooms,rent,owner_id,emp_id,branch_id)
>     values('PA14','LONDON','NW2','Flat','5','430','CO23','E001','B003');
>     insert into property_for_rent
>     values('PW23','KUNRI','OOI','House','4','240','AS32','E002','B002');
>     end;
>     /
> 
1 rows affected

*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=5d1eb18aebef77bfe194b90e8f81e89f)*
