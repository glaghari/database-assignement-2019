...
<!-- -->
>     select count(*) as totalEmployee , sum(salary) as sumSalary , avg(salary) avgSalary , max(salary) maxSalary ,  min(salary) minSalary
>     from Employee
> 
> | TOTALEMPLOYEE | SUMSALARY | AVGSALARY | MAXSALARY | MINSALARY |
> | ------------: | --------: | --------: | --------: | --------: |
> |             3 |    177000 |     59000 |    100000 |     32000 |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=9cdbd556377f0faf4dd8a3f47789ffbd)*
