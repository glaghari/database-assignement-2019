...
>     insert into Branch values ('B004', 'mithi', 'kashmir choak');
>     end;
>     /
> 
1 rows affected
...
>     insert into Employee 
>       values('E004', 'rajesh', 'maheshwari', 'rajesh@gmail.com', 'Worker' , 'M', date '1998-04-2', date '2018-12-12', 30000 , 'B001');
>     end;
>     /
> 
1 rows affected
...
> | E004   | rajesh     | maheshwari | rajesh@gmail.com        | Worker     | M      | 02-APR-98 | 12-DEC-18 |  30000 | B001      |
...
*db<>fiddle [here](https://dbfiddle.uk/?rdbms=oracle_11.2&fiddle=2f14629a76b6b4596277e743cf791292)*
