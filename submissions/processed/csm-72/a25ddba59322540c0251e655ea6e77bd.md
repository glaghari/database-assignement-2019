...
<!-- -->
>     INSERT INTO Branches VALUES ("B001","MPM-01","Mirpur Mathelo","Any Where In Mirpur Mathelo"),
>     ("B002","HYD-01","Hyderabad","Any where In Hyderabad"),
>     ("B003","MPK-01","Mirpur Khas","Any Where In Mirpur Khas");
> 
> ✓
...
> | branch_address | varchar(255) | NO   |     | <em>null</em>    |       |
...
> 
> | branch_code | branch_name | branch_city    | branch_address              |
> | :---------- | :---------- | :------------- | :-------------------------- |
> | B001        | MPM-01      | Mirpur Mathelo | Any Where In Mirpur Mathelo |
> | B002        | HYD-01      | Hyderabad      | Any where In Hyderabad      |
> | B003        | MPK-01      | Mirpur Khas    | Any Where In Mirpur Khas    |
...
<!-- -->
>     #### 28/10/2019 task 4,5,6
> 
> ✓

<!-- -->
>     #task 4
>     select br.branch_code,br.branch_name,br.branch_city,count(*) as total_employees,
>     sum(emp.emp_salary_year) as total_salary, avg(emp.emp_salary_year) as avarage_salary,
>     min(emp.emp_salary_year) as min_salary,max(emp.emp_salary_year) as max_salary
>     from Employee_list emp , Branches br where emp.working_branch = br.branch_code
>     group by br.branch_code
> 
> | branch_code | branch_name | branch_city    | total_employees | total_salary | avarage_salary | min_salary | max_salary |
> | :---------- | :---------- | :------------- | --------------: | -----------: | -------------: | ---------: | ---------: |
> | B001        | MPM-01      | Mirpur Mathelo |               4 |      4400000 |   1100000.0000 |     400000 |    2000000 |
> | B002        | HYD-01      | Hyderabad      |               3 |     11500000 |   3833333.3333 |     500000 |    9000000 |
> | B003        | MPK-01      | Mirpur Khas    |               3 |      5900000 |   1966666.6667 |     200000 |    5000000 |

<!-- -->
>     #task 5
>     select * from Employee_list where working_branch = 
>     (select branch_code from Branches where branch_city = "Hyderabad");
> 
> | employee_id | working_branch | emp_name_first | emp_name_last | emp_f_name | emp_caste | emp_cnic        | emp_dob    | emp_joining_date | emp_salary_year | emp_is_full_time |
> | ----------: | :------------- | :------------- | :------------ | :--------- | :-------- | :-------------- | :--------- | :--------------- | --------------: | ---------------: |
> |           4 | B002           | bbbbb          | bbbb          | bbbbb      | bbbb      | 33333-3333333-3 | 2000-03-13 | 2018-01-01       |         2000000 |                0 |
...
<!-- -->
>     # task 6
>     select emp.*,br.branch_name,br.branch_city,br.branch_address from 
>     Employee_list emp, Branches br where br.branch_code=emp.working_branch;
> 
> | employee_id | working_branch | emp_name_first | emp_name_last | emp_f_name      | emp_caste | emp_cnic        | emp_dob    | emp_joining_date | emp_salary_year | emp_is_full_time | branch_name | branch_city    | branch_address              |
